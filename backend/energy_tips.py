...
load_dotenv()
WEATHER_API_KEY = os.getenv("WEATHER_API_KEY") or '093a44f57ca807d2b7a6f6b1163da88c'

@app.route('/')
def serve_energy_tips():
    # Serve energy-tips.html from the templates/static folder
    return send_from_directory('templates', 'energy-tips.html')
